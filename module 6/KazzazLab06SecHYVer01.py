...
def main():
    ...
    rctDice01 = drawDice(win, Point(50, 50), 50, 6)
    rctDice02 = drawDice(win, Point(100, 100), 50, 5)
    rctDice03 = drawDice(win, Point(150, 150), 50, 4)
    rctDice04 = drawDice(win, Point(200, 200), 50, 3)
    rctDice05 = drawDice(win, Point(250, 250), 50, 2)
    rctDice06 = drawDice(win, Point(300, 300), 50, 1)
