# Project:      HW4 (KazzazMarkHW4SecHYVer02.py)
# Name:         Mark Kazzaz
# Date:         2017-08-12
...
from time import sleep      ## to help with dice rolls
...
def main():
    ...
    while isAllDiceRolled == False:
        ...
        if checkWithinRectangle(clkUser, rctDice01):
            ...
            if isDice01Rolled == False:
                ...
                ## consider if we exhausted all available rolls to exit the while loop
    ...
    txtPrompt.setText('All dice have been rolled. You rolled {}. \n Press Exit to close.'.format(str(intDiceRollTotal)))
